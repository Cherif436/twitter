...
export default function Post({post, id}) {
  ...
  return (
    <div className="flex p-3 border-b border-gray-200 cursor-pointer">
      {/* User image */}
      <img className="mr-4 rounded-full h-11 w-11" src={post?.data()?.userImg} alt="" />
      {/* right side */}
      <div className="flex-1">
        ...
        {/* Post Image */}
        <img onClick={() => router.push(`/posts/${id}`)} className="mr-2 rounded-2xl" src={post?.data()?.image} alt="" />
