  ...
  return (
    <>
      {session && (
        ...
        <img onClick={signOut} src={session.user.image} alt="user-img" className="rounded-full cursor-pointer w-11 h-11 hover:brightness-95" />
        <div className="w-full divide-y divide-gray-200">
          ...
          {selectedFile && (
            <div className="relative">
              <XIcon onClick={() => setSelectedFile(null)} className="absolute m-1 text-black border border-white rounded-full shadow-md cursor-pointer h-7" />
